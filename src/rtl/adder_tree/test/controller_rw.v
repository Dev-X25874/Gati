...
module controller_rw#(
    parameter N_FIFO = 16, parameter DATA_WIDTH = 8, parameter ADDR_WIDTH = 9
)(
    input i_clk,
    input i_rx_valid,
...
always @(posedge i_clk) begin
    if(~i_fifo_empty) begin
        if(i_fifo_occupants >= {N_FIFO{9'd8}}) begin //as occupancy in each fifo reaches 16, the read enable of them get high at once
            o_fifo_rden <= 16'b1111_1111_1111_1111; //all fifos read enable get high together
        end
        else begin
            o_fifo_rden <= 16'b0000_0000_0000_0000;
        end
    end
    else begin
        o_fifo_rden <= 16'b0000_0000_0000_0000;
