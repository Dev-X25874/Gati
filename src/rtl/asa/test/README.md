...
1. The illustration below depicts how the input matrix from the script integrates with the systolic array (SA) design:
    ...
    ![Matrix Data Flow](https://github.com/vicharak-in/uart_SA/blob/master/img/matrix_data_flow.jpg)
...
![Design Output](https://github.com/vicharak-in/uart_SA/blob/master/img/design_output.png)
