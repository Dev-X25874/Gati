...
always @(posedge clk) begin
    ...
    OUTPUT_CHECK: begin
        dout <= {AccEn, ImageDimAcc, ImageDimOutput, kernelItr, channelItr, outputaddr, accumulantaddr, opcode}; //this concates the different output signals for checking purpose
        state <= IDLE;
        //valid <= 1'b1;
    end
    endcase
