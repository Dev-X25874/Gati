...
assign o_north_empty = north_empty;
...
(* async_reg = "true" *) reg [(COL * (W_DATA + 1))-1 : 0] x1=0;
(* async_reg = "true" *) reg [(COL * (W_DATA + 1))-1 : 0] x2=0;
(* async_reg = "true" *) reg [(ROW * (W_DATA + 1))-1 : 0] y1=0;
(* async_reg = "true" *) reg [(ROW * (W_DATA + 1))-1 : 0] y2=0;
