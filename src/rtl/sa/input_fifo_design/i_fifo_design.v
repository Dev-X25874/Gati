module i_fifo_design#(
    ...
    output o_serial_debug_data_1,
    output o_serial_debug_data_2,
    output [4:0] row_trigger_counter
);
...
fifo_integration #(
    ...
    .o_tx_debug_data_1(o_serial_debug_data_1),
    .o_tx_debug_data_2(o_serial_debug_data_2),
    .o_north_occupants(o_north_array_occupants),
    .trigger_cnt(row_trigger_counter)
);
