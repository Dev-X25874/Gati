...
module top_sa#(
    ...
    output [(N_SA * ROW)-1 : 0] o_image_ff_array_almost_empty,
    output [(N_SA * ROW)-1 : 0] o_image_ff_array_almost_full,
...
if(NSA_DSP == 0)begin
        sa_engine_dsp dsp_engine_inst (
            ...
            .o_image_ff_array_almost_empty(),
            .o_image_ff_array_almost_full(),
        ...
        for(i = 0; i < NSA_DSP; i = i +1)begin : DSP_SA_ENG
            sa_engine_dsp#(
                ...
                .o_image_ff_array_almost_full(o_image_ff_array_almost_full[(ROW * (N_SA - i))-1 -: ROW]),
    ...
    if(NSA_LUT == 0)begin
            ...
            for(j = 0; j < NSA_LUT; j = j + 1)begin : LUT_SA_ENG
                sa_engine_lut#(
                    ...
                    .o_image_ff_array_almost_full(o_image_ff_array_almost_full[(ROW * ((N_SA-NSA_DSP) - j))-1 -: ROW]),
