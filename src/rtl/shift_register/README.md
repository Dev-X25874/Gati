...
This block contains modules for Shift Register implementation and testing.
...
Modules for testing:
UART receiver, controllers, first set of fifos, shift register designs, a second set of fifos, controller after main design, singular fifo, controller for dividing data into 8 bits, and a UART transmitter. These modules are designed to facilitate data transmission and processing within a UART system.
