/*
   Synchronous fifo used for checking validity of data and storing it into memory.
   Refer to Efinity's BRAM wrapper to know more.
*/
module fifo_valid (
             clk,
             rst_n ,
...
memory_valid #(.DATA_WIDTH(DATA_WIDTH),
